...
assert.equal(JSON.stringify(domain.GROUP_STATUSES), JSON.stringify([
  'DRAFT',
  'OPEN',
  'CLOSED',
  'CONFIRMED',
...
assert.equal(JSON.stringify(domain.PARTICIPANT_STATUSES), JSON.stringify([
  'APPLIED',
  'APPROVED',
  'DEPOSITED',
  'CHECKED_IN',
...
assert.equal(JSON.stringify(settlement), JSON.stringify({
